This is just everything put together for a react,node,electron,electron builder app.
Yarn was used for the package manager.
Below is the create react app documentation which is u

the command yarn dist will build and package your app for whatever computer type you are using. 
